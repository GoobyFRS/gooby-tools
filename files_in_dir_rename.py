...
def main():
    #
    directory = r"S:\BulkMediaStorage\TV Shows\$SHOW"
...
#https://stackoverflow.com/questions/43728163/python-replace-all-spaces-with-underscores-and-convert-to-lowercase-for-all-fil
    [os.rename(os.path.join(directory, f), os.path.join(directory, f).replace('doctor who ', '').lower()) for f in os.listdir(directory)]
